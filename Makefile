...
TRAIN_INCS = $(INCS) \
Train.hpp ProfileTrainer.hpp ProfileTrainerOptions.hpp
...
CC_CFLAGS 	= $(ALGEBRA_CFLAGS) $(PROLIFIC_CFLAGS) $(BOOST_CFLAGS) $(SEQAN_CFLAGS)
...
CXX_CFLAGS 	= $(ALGEBRA_CFLAGS) $(PROLIFIC_CFLAGS) $(BOOST_CFLAGS) $(SEQAN_CFLAGS)
